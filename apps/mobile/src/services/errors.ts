const messages: Record<string, string> = {
  ...
  connection_post_invalid: "Il post di origine non e valido per questa richiesta.",
  reconnect_chat_not_found: "La connessione da ripristinare non e piu disponibile.",
  reconnect_not_allowed: "Non puoi ripristinare questa connessione.",
  reconnect_source_missing: "Non riesco a recuperare la conversazione originale.",
