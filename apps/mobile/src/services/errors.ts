const messages: Record<string, string> = {
  ...
  test_step_failed: "Il self-test si e fermato durante un controllo. Apri la diagnostica per vedere il passaggio e riprova.",
  test_user_login_failed: "L'utente automatico e stato creato ma non riesce ad accedere.",
  nested_function_failed: "Una funzione backend usata dal self-test ha restituito un errore.",
  test_rate_limit_exceeded: "Hai gia eseguito diversi self-test nell'ultima ora. Riprova piu tardi.",
  test_rate_limit_failed: "Il controllo anti-abuso del self-test non e disponibile.",
